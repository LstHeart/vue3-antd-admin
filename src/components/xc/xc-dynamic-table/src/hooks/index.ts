...
import type { XCDynamicTableProps, XCDynamicTableEmitFn } from '../xc-dynamic-table';
...
export type XCDynamicTableType = XCDynamicTableProps &
  TableState &
  TableMethods &
  ExportData2Excel & { emit: XCDynamicTableEmitFn };
