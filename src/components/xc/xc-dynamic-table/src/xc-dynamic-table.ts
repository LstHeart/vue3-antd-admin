...
import type XCDynamicTable from './xc-dynamic-table.vue';
...
export const xcDynamicTableProps = {
  ...tableProps(),
  rowKey: {
...
export const xcDynamicTableEmits = {
  change: (...rest: OnChangeCallbackParams) => rest.length === 4,
  'toggle-advanced': (isAdvanced: boolean) => isBoolean(isAdvanced),
};

export type XCDynamicTableProps = ExtractPropTypes<typeof xcDynamicTableProps>;
export type XCDynamicTableEmits = typeof xcDynamicTableEmits;

export type XCDynamicTableEmitFn = EmitFn<XCDynamicTableEmits>;
// @ts-ignore
export type XCDynamicTableInstance = InstanceType<typeof XCDynamicTable>;
